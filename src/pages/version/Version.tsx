  ...
  return (
    <section className='container'>
      <div className='mx-auto max-w-3xl'>
        <h1 className='scroll-m-20 text-4xl font-extrabold tracking-tight text-balance md:text-5xl'>
          Version Info
        </h1>
        <p className='text-muted-foreground text-xl md:text-lg'>
